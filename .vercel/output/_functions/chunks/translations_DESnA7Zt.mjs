...
import { A as AstroUserError, o as AstroError, U as UnknownContentCollectionError, c as createComponent, y as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, z as renderUniqueStylesheet, B as renderScriptElement, C as createHeadAndContent, r as renderComponent } from './astro/server_D1alfyVi.mjs';
import 'piccolore';
import * as devalue from 'devalue';
import i18next from 'i18next';

const starlightConfig = {"description":"Tài liệu hướng dẫn kỹ thuật và tối ưu hóa hệ thống với HyperLis","logo":{"src":"./src/assets/logo.png","alt":"","replacesTitle":false},"social":{"github":{"label":"GitHub","url":"https://github.com/ZitTechLab/HyperLis"},"facebook":{"label":"Facebook","url":"https://www.facebook.com/ZitTechLab/"}},"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":4},"editLink":{},"sidebar":[{"label":"Bắt đầu","translations":{},"collapsed":false,"items":[{"label":"Tổng quan về HyperLis","translations":{},"slug":"getting-started/overview","attrs":{}},{"label":"Tải & cài đặt HyperLis","translations":{},"slug":"getting-started/installation","attrs":{}},{"label":"Lưu ý sử dụng HyperLis","translations":{},"slug":"getting-started/safety-policy","attrs":{}},{"label":"Câu hỏi thường gặp (FAQ)","translations":{},"slug":"getting-started/faq","attrs":{}},{"label":"Về HyperLis & Tác giả","translations":{},"slug":"getting-started/about-hyperlis","attrs":{}},{"label":"Cài đặt ngôn ngữ","translations":{},"slug":"getting-started/language","attrs":{}},{"label":"Nhật ký thay đổi (Changelog)","translations":{},"slug":"getting-started/changelog","attrs":{}}]},{"label":"Dashboard","translations":{},"collapsed":false,"items":[{"label":"Giao diện Dashboard","translations":{},"slug":"dashboard/dashboard","attrs":{}}]},{"label":"Chung","translations":{},"collapsed":false,"items":[{"label":"Hệ thống","translations":{},"slug":"general/system","attrs":{}},{"label":"Ứng dụng","translations":{},"slug":"general/apps","attrs":{}},{"label":"Quyền riêng tư","translations":{},"slug":"general/privacy","attrs":{}},{"label":"Ổ đĩa","translations":{},"slug":"general/disk-drives","attrs":{}}]},{"label":"Windows","translations":{},"collapsed":false,"items":[{"label":"Hệ thống","translations":{},"slug":"windows/system","attrs":{}},{"label":"Quyền riêng tư","translations":{},"slug":"windows/privacy","attrs":{}},{"label":"Chơi game","translations":{},"slug":"windows/gaming","attrs":{}},{"label":"Chế độ nguồn","translations":{},"slug":"windows/power-plan","attrs":{}},{"label":"Cập nhật Windows (Windows Update)","translations":{},"slug":"windows/windows-update","attrs":{}},{"label":"Thanh tác vụ","translations":{},"slug":"windows/taskbar","attrs":{}},{"label":"Quản lý AI trên trình duyệt","translations":{},"slug":"windows/browser-ai","attrs":{}},{"label":"Mở rộng","translations":{},"slug":"windows/extras","attrs":{}},{"label":"Tinh chỉnh nâng cao","translations":{},"slug":"windows/advanced-tweaking","attrs":{}}]},{"label":"Ứng dụng UWP","translations":{},"collapsed":false,"items":[{"label":"Ứng dụng UWP","translations":{},"slug":"uwp-apps/uwp-apps","attrs":{}}]},{"label":"Khởi chạy","translations":{},"collapsed":false,"items":[{"label":"Khởi chạy","translations":{},"slug":"startup-apps/startup-apps","attrs":{}}]},{"label":"Tải xuống","translations":{},"collapsed":false,"items":[{"label":"Tải xuống","translations":{},"slug":"download/download","attrs":{}}]},{"label":"Dọn dẹp","translations":{},"collapsed":false,"items":[{"label":"Dọn dẹp","translations":{},"slug":"cleaning/cleaning","attrs":{}}]},{"label":"Mạng","translations":{},"collapsed":false,"items":[{"label":"Thông tin card mạng (NIC)","translations":{},"slug":"network/network-information","attrs":{}},{"label":"Đổi DNS & Quản lý DNS","translations":{},"slug":"network/dns-management","attrs":{}},{"label":"Tối ưu hóa mạng","translations":{},"slug":"network/network-optimization","attrs":{}},{"label":"Kiểm tra Ping & Độ trễ","translations":{},"slug":"network/ping-tool","attrs":{}}]},{"label":"USB Boot","translations":{},"collapsed":false,"items":[{"label":"USB Boot","translations":{},"slug":"usb-boot/usb-boot","attrs":{}}]},{"label":"Phần cứng","translations":{},"collapsed":false,"items":[{"label":"Phần cứng","translations":{},"slug":"hardware-info/hardware-info","attrs":{}}]},{"label":"Quản lý bản quyền","translations":{},"collapsed":false,"items":[{"label":"Quản lý bản quyền","translations":{},"slug":"manage-license/manage-license","attrs":{}}]},{"label":"Đổi phiên bản","translations":{},"collapsed":false,"items":[{"label":"Đổi phiên bản Windows","translations":{},"slug":"convert-skus/convert-skus","attrs":{}}]},{"label":"Cài đặt Office","translations":{},"collapsed":false,"items":[{"label":"Cài đặt Microsoft Office","translations":{},"slug":"office-setup/office-setup","attrs":{}}]},{"label":"Tính năng khác","translations":{},"collapsed":false,"items":[{"label":"Tính năng khác","translations":{},"slug":"extend-features/extend-features","attrs":{}}]},{"label":"WSAP","translations":{},"collapsed":false,"items":[{"label":"Cài đặt Windows tự động (WSAP)","translations":{},"slug":"wsap/wsap","attrs":{}}]},{"label":"Sửa lỗi","translations":{},"collapsed":false,"items":[{"label":"Sửa lỗi máy in","translations":{},"slug":"errors/printer-errors","attrs":{}},{"label":"Sửa lỗi Windows","translations":{},"slug":"errors/windows-errors","attrs":{}}]},{"label":"Cài đặt","translations":{},"collapsed":false,"items":[{"label":"Cài đặt","translations":{},"slug":"settings/settings","attrs":{}}]}],"head":[{"tag":"link","attrs":{"rel":"icon","type":"image/png","href":"/favicon.png"},"content":""},{"tag":"link","attrs":{"rel":"icon","type":"image/png","sizes":"32x32","href":"/favicon-32x32.png"},"content":""},{"tag":"link","attrs":{"rel":"icon","type":"image/png","sizes":"16x16","href":"/favicon-16x16.png"},"content":""},{"tag":"link","attrs":{"rel":"apple-touch-icon","sizes":"180x180","href":"/apple-touch-icon.png"},"content":""},{"tag":"script","attrs":{"src":"/uwu.js","defer":true},"content":""}],"lastUpdated":true,"pagination":true,"favicon":{"href":"/favicon.png","type":"image/png"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"vi":"HyperLis Docs"},"isMultilingual":true,"defaultLocale":{"label":"Tiếng Việt","lang":"vi","dir":"ltr","locale":"root"},"locales":{"root":{"label":"Tiếng Việt","lang":"vi","dir":"ltr"},"en":{"label":"English","lang":"en","dir":"ltr"}}};

const project = {"build":{"format":"directory"},"root":"file:///E:/GGAI/HyperLis_Documentation-main/","srcDir":"file:///E:/GGAI/HyperLis_Documentation-main/src/","trailingSlash":"ignore"};
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_C1ajZ5JQ.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://zittechlab.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BPjzsG86.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_4-_l10g8.mjs');
...
export { BuiltInDefaultLocale as B, stripTrailingSlash as a, stripLeadingSlash as b, stripHtmlExtension as c, ensureTrailingSlash as d, ensureHtmlExtension as e, getCollectionPathFromRoot as f, getCollection as g, pickLang as h, stripLeadingAndTrailingSlashes as i, ensureLeadingSlash as j, stripExtension as k, getEntry as l, getCollectionPath as m, project as p, renderEntry as r, starlightConfig as s, useTranslations as u };
